---
title: "Seasonal forecast development for anadromous brown trout smolts"
date: "`r format(Sys.time(), '%d %B, %Y')`"
output: rmarkdown::html_vignette
bibliography: Literature_cited.bib
csl: FishFisheries.csl
vignette: >
  %\VignetteIndexEntry{Seasonal forecast development for anadromous brown trout smolts}
...
```{r catchment_specific_data_fish, out.width="100%", eval=FALSE}
# ---------------------------------------------------------------------------------------------------------- #
# FISH COUNTS ----
# ---------------------------------------------------------------------------------------------------------- #
...
png(filename = paste0(dirName,"catchment_specific_data-1-trout.png"), height = 2300, width = 2300, res =300)
par(mfcol = c(13,3),oma = c(8,4,1,1), mar = c(0.5,3,0.1,0.1))
...
mtext(side = 2,text = expression(italic("S. trutta ")~smolt~count),outer = TRUE,line = 2)
...
```{r catchment_specific_data-1-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
...
```{r catchment_specific_data-2-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
...
```{r catchment_specific_data-3-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
...
```{r lunar_solar_data-1-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
knitr::include_graphics(path = paste0(dirName,"lunar_solar_data-1-trout.png"))
```

```{r lunar_solar_data-2-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
...
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/trout_wflow_figs/")
png(filename = paste0(dirName,"access_climate_data-3-trout_",x,"_SF.png"), height = 2300, width = 2300, res =300)
...
```{r pre_process_climate_data-1-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/meteo_data_bias_adj/")
knitr::include_graphics(path = paste0(dirName,"ERA5_bcc_tas.png"))
```

```{r pre_process_climate_data-2-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/meteo_data_bias_adj/")
knitr::include_graphics(path = paste0(dirName,"ERA5_bcc_pr.png"))
```

```{r pre_process_climate_data-3-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/meteo_data_bias_adj/")
...
```{r model_hydrology_water_temp-6-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/air_water_temp_model/")
knitr::include_graphics(path = paste0(dirName,"air_water_cal_Fe.png"))
```

```{r model_hydrology_water_temp-7-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/air_water_temp_model/")
knitr::include_graphics(path = paste0(dirName,"air_water_val_Fe.png"))
```

```{r model_hydrology_water_temp-8-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/air_water_temp_model/")
knitr::include_graphics(path = paste0(dirName,"air_water_val_MRpap.png"))
```

```{r model_hydrology_water_temp-9-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/air_water_temp_model/")
knitr::include_graphics(path = paste0(dirName,"air_water_val_MRtid.png"))
```

```{r model_hydrology_water_temp-10-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/air_water_temp_model/")
...
Data for 1981 - 1992 were used to refine model structure for trout smolts.

```{r model_trout_counts_1981_1992_fit_model,eval = FALSE}
# ---------------------------------------------------------------------------------------------------------- #
...
```{r model_trout_counts_1981_1992_fit-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
knitr::include_graphics(path = paste0(dirName,"FigS5a.png"))
```

```{r model_trout_counts_1981_1992_fit-trout-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
knitr::include_graphics(path = paste0(dirName,"FigS5b.png"))
```

```{r model_trout_counts_1981_1992_fit-trout-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
knitr::include_graphics(path = paste0(dirName,"FigS5c.png"))
```

```{r model_trout_counts_1981_1992_fit-trout-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
knitr::include_graphics(path = paste0(dirName,"FigS5d.png"))
```

```{r model_trout_counts_1981_1992_fit-trout-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
...
```{r model_trout_counts_1981_1992_check_influence_I,eval = FALSE}
# -------------------------------------------------------------------------------------------------- #
# INFLUENTIAL YEARS
...
```{r model_trout_counts_1981_1992_check_influence_II,eval = FALSE}
library(glmmTMB)
library(car)
...
```{r model_trout_counts_1981_1992_check_influence_III,eval = FALSE}
chosen_model_influence <- readRDS(paste0(system.file("extdata",
                                 package = "fishcastr"),
                     "/vignette_data/chosen_model_influence.rds"))
...
```{r model_trout_counts_1981_1992_check_influence_IV,eval = FALSE}
...
```{r model_trout_counts_1981_1992_check_influence_IV-trout, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
...
```{r model_trout_counts_1981_1992_plot_interactions,eval = FALSE}
...
```{r model_trout_counts_1981_1992_plot_interactions-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
knitr::include_graphics(path = paste0(dirName,"FigS5g.png"))
```

```{r model_trout_counts_1981_1992_plot_interactions-trout-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/")
...
```{r model_trout_counts_1981_1992_plausible_glmmTMB,eval = FALSE}
# -------------------------------------------------------------------------------------------------- #
...
```{r model_trout_counts_1981_2018_fit_loo,eval = FALSE}            
# ---------------------------------------------------------------------------------------------------------- #
# LOAD COUNT AND PREDICTOR DATA ----
# ---------------------------------------------------------------------------------------------------------- #
data_stsmolt_enviro_1981_2019 <- readRDS(paste0(system.file("extdata",
...
```{r model_trout_counts_2019_fit_operational,eval = FALSE}
# ---------------------------------------------------------------------------------------------------------- #
# LOAD COUNT AND PREDICTOR DATA ----
# ---------------------------------------------------------------------------------------------------------- #
data_stsmolt_enviro_1981_2019 <- readRDS(paste0(system.file("extdata",
...
```{r model_trout_counts_2019_fit_operational-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5a.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5b.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5c.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5d.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5e.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5f.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5g.png"))
```

```{r model_trout_counts_2019_fit_operational-trout-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/trout/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5h.png"))
```
...
```{r figure_5a_trout_methods, warning = FALSE, echo = FALSE,  fig.height=7, fig.width=7, eval = FALSE}
...
```{r figure_5a_trout_plots, warning = FALSE, echo = FALSE,  fig.height=7, fig.width=7, eval = FALSE}
...
```{r figure_5a_trout_result_tab-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                                   "/vignette_figures/Fig5a/trout/")
...
```{r figure_5a_trout_plots-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_5th.png"))
```

```{r figure_5a_trout_plots-trout-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_25th.png"))
```

```{r figure_5a_trout_plots-trout-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_33rd.png"))
```

```{r figure_5a_trout_plots-trout-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_50th.png"))
```

```{r figure_5a_trout_plots-trout-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_66th.png"))
```

```{r figure_5a_trout_plots-trout-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_75th.png"))
```

```{r figure_5a_trout_plots-trout-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_95th.png"))
```

```{r figure_5a_trout_plots-trout-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_trout_sim_mean.png"))
```
...
```{r figure_5b_trout_methods, warning = FALSE, echo = FALSE,  fig.height=7, fig.width=7, eval = FALSE}
...
```{r figure_5b_trout_plots, warning = FALSE, echo = FALSE,  fig.height=7, fig.width=7, eval = FALSE}
library(fishcastr)
...
```{r figure_5b_trout_result_tab-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                                   "/vignette_figures/Fig5b/trout/")
...
```{r figure_5b_trout_plots-trout-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_5th.png"))
```

```{r figure_5b_trout_plots-trout-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_25th.png"))
```

```{r figure_5b_trout_plots-trout-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_33rd.png"))
```

```{r figure_5b_trout_plots-trout-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_50th.png"))
```

```{r figure_5b_trout_plots-trout-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_66th.png"))
```

```{r figure_5b_trout_plots-trout-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_75th.png"))
```

```{r figure_5b_trout_plots-trout-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_95th.png"))
```

```{r figure_5b_trout_plots-trout-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/trout/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_trout_sim_mean.png"))
```
