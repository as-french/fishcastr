---
title: "Seasonal forecast development for European silver eel"
date: "`r format(Sys.time(), '%d %B, %Y')`"
output: rmarkdown::html_vignette
bibliography: Literature_cited.bib
csl: FishFisheries.csl
vignette: >
  %\VignetteIndexEntry{Seasonal forecast development for European silver eel}
...
png(filename = paste0(dirName,"catchment_specific_data-1-eel.png"), height = 2300, width = 2300, res =300)
...
mtext(side = 2,text = expression(italic("A. anguilla ")~silver~count),outer = TRUE,line = 2)
...
```{r catchment_specific_data-1-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
...
```{r catchment_specific_data-2-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
...
```{r catchment_specific_data-3-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
...
```{r lunar_solar_data-1-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
knitr::include_graphics(path = paste0(dirName,"lunar_solar_data-1-eel.png"))
```

```{r lunar_solar_data-2-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
...
dirName <- paste0(system.file("extdata", package = "fishcastr"),"/eel_wflow_figs/")
png(filename = paste0(dirName,"access_climate_data-3-eel_",x,"_SF.png"), height = 2300, width = 2300, res =300)
...
era5_reanalysis_bcc <- fishcastr::convert_grid_to_dataframe(grid_obj = fishcastr::grid_ERA5_1979_2019_Jun_bc)[,-2]
names(era5_reanalysis_bcc) <- c("date","tas_era5_bcc","pr_era5_bcc","petH_era5_bcc")

#load(file = paste0(system.file("extdata",
#                               package = "fishcastr"),
#                   "/grid_ERA5_1979_2019_Jun_raw.rda"))

grid_ERA5_1979_2019_Jun_raw <- readRDS(file = paste0(system.file("extdata",
                               package = "fishcastr"),
                   "/grid_ERA5_1979_2019_Jun_raw.rds"))

era5_reanalysis_raw <-  fishcastr::convert_grid_to_dataframe(grid_obj = grid_ERA5_1979_2019_Jun_raw)[,-2]
names(era5_reanalysis_raw) <- c("date","tas_era5_raw","pr_era5_raw","petH_era5_raw")
rm(grid_ERA5_1979_2019_Jun_raw)
...
# ----------------------------------------------------------------------------------------------------------#
# mean
mean(era5_reanalysis_raw$tas_era5_raw) - mean(met_eireann_obs$tas_met_eireann) # -0.7385109
mean(era5_reanalysis_bcc$tas_era5_bcc) - mean(met_eireann_obs$tas_met_eireann) # -0.01929378
...
# ----------------------------------------------------------------------------------------------------------#
# mean
mean(era5_reanalysis_raw$pr_era5_raw) - mean(met_eireann_obs$pr_met_eireann) # -0.9335397
mean(era5_reanalysis_bcc$pr_era5_bcc) - mean(met_eireann_obs$pr_met_eireann) # 0.1553765
...
# ----------------------------------------------------------------------------------------------------------#
# mean
mean(era5_reanalysis_raw$petH_era5_raw) - mean(met_eireann_obs$petH_met_eireann) # -0.139954
mean(era5_reanalysis_bcc$petH_era5_bcc) - mean(met_eireann_obs$petH_met_eireann) # 0.004437841
...
Data for 1981 - 1992 were used to refine model structure for silver eels.

```{r model_eel_counts_1981_1992_fit_model,eval = FALSE}
# ---------------------------------------------------------------------------------------------------------- #
...
```{r model_eel_counts_1981_1992_fit-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
knitr::include_graphics(path = paste0(dirName,"FigS5a.png"))
```

```{r model_eel_counts_1981_1992_fit-eel-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
knitr::include_graphics(path = paste0(dirName,"FigS5b.png"))
```

```{r model_eel_counts_1981_1992_fit-eel-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
knitr::include_graphics(path = paste0(dirName,"FigS5c.png"))
```

```{r model_eel_counts_1981_1992_fit-eel-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
knitr::include_graphics(path = paste0(dirName,"FigS5d.png"))
```

```{r model_eel_counts_1981_1992_fit-eel-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
...
```{r model_eel_counts_1981_1992_check_influence_I,eval = FALSE}
# -------------------------------------------------------------------------------------------------- #
# INFLUENTIAL YEARS
...
chosen_model <- readRDS(paste0(system.file("extdata",
                                 package = "fishcastr"),
                     "/vignette_data/m3_eel_historic.rds"))
...
```{r model_eel_counts_1981_1992_check_influence_II,eval = FALSE}
library(glmmTMB)
library(car)
...
```{r model_eel_counts_1981_1992_check_influence_III,eval = FALSE}
chosen_model_influence <- readRDS(paste0(system.file("extdata",
                                 package = "fishcastr"),
                     "/vignette_data/chosen_model_influence.rds"))
...
```{r model_eel_counts_1981_1992_check_influence_IV,eval = FALSE}
...
```{r model_eel_counts_1981_1992_check_influence_IV-eel, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
...
```{r model_eel_counts_1981_1992_plot_interactions,eval = FALSE}
...
# -------------------------------------------------------------------------------------------------- #
# PLOT ALL TWO-WAY INTERACTIONS OF SELECTED MODEL (10)
# -------------------------------------------------------------------------------------------------- #
# interactions_list_3 <- list("1" = c("meanT","ln_discharge"),
#                           "2" = c("meanT","physio_optim_exp_mod_gaussian"),
#                           "3" = c("meanT","moonlight_exposure"),
#                           "4" = c("meanT","Delta_temp"),
#                           "5" = c("ln_discharge","physio_optim_exp_mod_gaussian"),
#                           "6" = c("ln_discharge","moonlight_exposure"),
#                           "7" = c("ln_discharge","Delta_temp"),
#                           "8" = c("physio_optim_exp_mod_gaussian","moonlight_exposure"),
#                           "9" = c("physio_optim_exp_mod_gaussian","Delta_temp"),
...
#   interactions::interact_plot(chosen_model,
#                             pred = !!(x[1]),
#                             modx = !!(x[2]),
#                             linearity.check = FALSE,interval = TRUE, int.width = 0.95,
#                             plot.points = TRUE,data = Train_data_scaled_centred_train) + coord_cartesian(ylim = c(0, max(Train_data_scaled_centred_train$seel)))
# })
# 
...
#                             modx = !!(x[2]),
#                             linearity.check = FALSE,interval = TRUE, int.width = 0.95,
#                             plot.points = FALSE,data = Train_data_scaled_centred_train)
# })
# 
# dirName <- paste0(getwd(),"/vignette_figures", "/count_model_checks", "/", sep = "", collapse = NULL)
# png(file = paste0(dirName,'eel/FigS5h.png'), width=4000, height=4000, res=300)
...
int_plots <- lapply(interactions_list_3,FUN = function(x){
  ...
  # set x axis lims
  # 75th
  data_75_plus <- Train_data_scaled_centred_train[Train_data_scaled_centred_train[[x[2]]] >= quantile(Train_data_scaled_centred_train[[x[2]]], probs = c((((75+50)/2)/100))),]
xlims75 <- c(range(data_75_plus[[x[1]]]))
  # 50th
  data_50_plus <- Train_data_scaled_centred_train[Train_data_scaled_centred_train[[x[2]]] >= quantile(Train_data_scaled_centred_train[[x[2]]], probs = c((((50+50)/2)/100))),]
xlims50 <- c(range(data_50_plus[[x[1]]]))
  # 75th
  data_25_plus <- Train_data_scaled_centred_train[Train_data_scaled_centred_train[[x[2]]] >= quantile(Train_data_scaled_centred_train[[x[2]]], probs = c((((25+50)/2)/100))),]
...
xlims <- c(xlims_min,xlims_max)
 ...
 int_plot <- interactions::interact_plot(chosen_model,
                            ...
                            plot.points = TRUE,data = Train_data_scaled_centred_train, allow.new.levels=TRUE) + scale_x_continuous(expand = c(0,0)) + coord_cartesian(clip = 'on', ylim = c(0, max(Train_data_scaled_centred_train$seel)),xlim = xlims)
...
int_plot <-  interactions::interact_plot(chosen_model,
                            ...
                            modx.values = c(quantile(Train_data_scaled_centred_train[[x[2]]],
                                                     probs = c(0.25,0.50,0.75))),
                            plot.points = FALSE,data = Train_data_scaled_centred_train, allow.new.levels=TRUE) + scale_x_continuous(expand = c(0,0)) + coord_cartesian(xlim = xlims)

# extract auto ylims and change to max count if exceeding it.
if(ggplot_build(int_plot)$layout$panel_scales_y[[1]]$range$range[2] >= max(Train_data_scaled_centred_train$seel)){
int_plot$coordinates$limits$y <- c(0,max(Train_data_scaled_centred_train$seel))
}
return(int_plot)
})
...
```{r model_eel_counts_1981_1992_plot_interactions-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
knitr::include_graphics(path = paste0(dirName,"FigS5g.png"))
```

```{r model_eel_counts_1981_1992_plot_interactions-eel-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/")
...
```{r model_eel_counts_1981_1992_plausible_glmmTMB,eval = FALSE}
# -------------------------------------------------------------------------------------------------- #
...
```{r model_eel_counts_1981_2018_fit_loo,eval = FALSE}            
# ---------------------------------------------------------------------------------------------------------- #
# LOAD COUNT AND PREDICTOR DATA ----
# ---------------------------------------------------------------------------------------------------------- #
data_seel_enviro_1981_2019 <- readRDS(paste0(system.file("extdata",
...
# Test_data <- subset(data_seel_enviro_1981_2018,
#                     eel_year %in% c(x), select = c(date,
#                                                    seel,
#                                                    eel_year,
#                                                    ln_migration_prep,
#                                                    eel_yday_biofix,
...
```{r model_eel_counts_2019_fit_operational,eval = FALSE}
# ---------------------------------------------------------------------------------------------------------- #
# LOAD COUNT AND PREDICTOR DATA ----
# ---------------------------------------------------------------------------------------------------------- #
data_seel_enviro_1981_2019 <- readRDS(paste0(system.file("extdata",
...
```{r model_eel_counts_2019_fit_operational-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5a.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5b.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5c.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5d.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5e.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5f.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5g.png"))
```

```{r model_eel_counts_2019_fit_operational-eel-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/count_model_checks/eel/op_model/")
knitr::include_graphics(path = paste0(dirName,"FigS5h.png"))
```
...
```{r figure_5a_eel_result_tab-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                                   "/vignette_figures/Fig5a/eel/")
...
```{r figure_5a_eel_plots-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_5th.png"))
```

```{r figure_5a_eel_plots-eel-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_25th.png"))
```

```{r figure_5a_eel_plots-eel-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_33rd.png"))
```

```{r figure_5a_eel_plots-eel-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_50th.png"))
```

```{r figure_5a_eel_plots-eel-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_66th.png"))
```

```{r figure_5a_eel_plots-eel-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_75th.png"))
```

```{r figure_5a_eel_plots-eel-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_95th.png"))
```

```{r figure_5a_eel_plots-eel-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5a/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5a_ERA5_eel_sim_mean.png"))
```
...
```{r figure_5b_eel_result_tab-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                                   "/vignette_figures/Fig5b/eel/")
...
```{r figure_5b_eel_plots-eel-1, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_5th.png"))
```

```{r figure_5b_eel_plots-eel-2, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_25th.png"))
```

```{r figure_5b_eel_plots-eel-3, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_33rd.png"))
```

```{r figure_5b_eel_plots-eel-4, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_50th.png"))
```

```{r figure_5b_eel_plots-eel-5, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_66th.png"))
```

```{r figure_5b_eel_plots-eel-6, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_75th.png"))
```

```{r figure_5b_eel_plots-eel-7, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_95th.png"))
```

```{r figure_5b_eel_plots-eel-8, out.width="100%", eval=TRUE}
dirName <- paste0(system.file("extdata", package = "fishcastr"),
                  "/vignette_figures/Fig5b/eel/")
knitr::include_graphics(path = paste0(dirName,"Fig5b_SEAS5_eel_sim_mean.png"))
```
