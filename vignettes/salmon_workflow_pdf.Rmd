---
title: 'Appendix S2: A seasonal forecasting workflow for the seaward migrations of
...
tab <- knitr::kable(res_tab,row.names = FALSE, format = "latex", caption = "(ref:figure-5b-salmon-result-tab-salmon-1)",
                    booktabs = TRUE)
#library(magrittr)
#tab %>% kableExtra::kable_classic(full_width = FALSE,html_font = "Arial")
tab
