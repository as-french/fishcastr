...
#     ),
#   format = "html",
#   caption = "European eel (*A. anguilla*) forecast years defined for Burrishoole between 1981 and 2018. Forecast year start dates and end dates are defined concurrently. Forecast year start dates are denoted by the first day of the calendar year that follows a consecutive period of 10 days during which water temperatures exceeded 11 degrees Celsius."
#   , booktabs = TRUE)
...
#eel_year_table_html <-
#  kableExtra::kable_styling(kable_input = tab_eel_html, position = "center", font_size = 12)
...
(ref:appendix-s1-table) *European eel (*A. anguilla*) forecast years defined for Burrishoole between 1981 and 2018. Forecast year start dates and end dates are defined concurrently. Forecast year start dates are denoted by the first day of the calendar year that follows a consecutive period of 10 days during which water temperatures exceeded 11 degrees Celsius.*
