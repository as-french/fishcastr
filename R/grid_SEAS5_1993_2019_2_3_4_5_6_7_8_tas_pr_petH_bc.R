#' Bias adjusted ECMWF's SEAS seasonal climate forecast at Burrishoole, Co Mayo,
#' Ireland
#'
...
#' members of the archived operational forecasts were selected. Dates: February
#' to August between the period 1993-02-01 to 2019-08-31. These grid data are
...
#'
"grid_SEAS5_1993_2019_2_3_4_5_6_7_8_tas_pr_petH_bc"
