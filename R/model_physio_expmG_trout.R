...
#'   2017) object that relates downstream migrating trout smolt count data to
...
#'   /data-raw/model_physio_expmG_trout_calibration.R for details of model
...
#'   (ssmolt_perc_run_int: re-scaled trout smolt count data;
#'   weighted_dds_water: photoperiod weighted degree days), data.frame object}
#'   \item{coefs}{A numeric vector of fitted model coefficents (see
#'   R/exp_mod_Gaussian_resp.R for explanation of model coefficents), bbmle:mle2
#'   object}
#'   \item{vcov_mat}{The variance covariance matrix of the fitted bbmle::mle2
#'   object} ... }
#'
"model_physio_expmG_trout"
