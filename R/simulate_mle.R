...
#'
#' This function generates simulations from a fitted bbmle::mle2 (Bolker & R
#' Core Team 2017) model object. Simulations are returned as a matrix. The
#' stochastic element of the simulations comes from randoms draws from the
#' conditional distribution of the response (e.g., generalised Poisson
#' distribution). However, mean predictions are generated by simulation from a
#' multivariate normal distribution, and 95% confidence intervals of this mean
#' (i.e., population prediction intervals) are generated within this function,
#' but not currently returned.
#'
