...
#' operational forecasts were selected. Dates: July to December between the
#' period 1993-07-01 to 2019-12-31. These grid data are raw (but rounded to 2
...
#'
"grid_SEAS5_1993_2019_7_8_9_10_11_12_tas_pr_petH_raw"
