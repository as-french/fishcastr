#' An exponentially modified Gaussian curve.
#'
...
#' @param lamb A constant that defines the rate of decline of the right tail of
#'   the curve.
#' @return y A numeric vector.
#' @examples
#' exp_mod_Gaussian_resp(x = 1:1500, c = 150, mu_exmg = 600,sigma_exmg = 100,lamb = 25)
#' @export
exp_mod_Gaussian_resp <-function(x, c, mu_exmg, sigma_exmg, lamb){
