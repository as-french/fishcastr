...
data_met_manual_station_1959_2019 <- readRDS(file = paste0(system.file("extdata", package = "fishcastr"),
...
# ---------------------------------------------------------------------------------------------------------- #
ewembi_1979_2016 <- readRDS(file = paste0(system.file("extdata", package = "fishcastr"),
                                          "/data_ewembi_1979_2016.rds"))
# ---------------------------------------------------------------------------------------------------------- #
# IMPORT AUTO STATION DATA "2005-01-01" "2019-09-17" (contains gaps) ---------------------------------------
# ---------------------------------------------------------------------------------------------------------- #
met_auto_2005_2019 <- readRDS(file = paste0(system.file("extdata", package = "fishcastr"),
...
# -------------------------------------------------------------------------------------------------------------- #
saveRDS(object = grid_met_obs_1979_2019, file = paste0(system.file("extdata", package = "fishcastr"),
...
saveRDS(object = data_met_obs_1979_2019, file = paste0(system.file("extdata", package = "fishcastr"),
                                                       "/data_met_obs_1979_2019.rds"))
rm(list = ls())
