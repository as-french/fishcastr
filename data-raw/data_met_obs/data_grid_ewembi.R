## code to prepare `data_ewembi` dataset goes here
...
# keep out of git. This ensures static data are not stored in github. Data will
# however be stored as rda for fishcastr package bundling.
...
data.prelim <- lapply(variables, function(x) loadeR::loadGridData(dataset, var = x, years = years,
                                                                  ...
                                                                  season = season))
# Approximately 12 minutes to download
