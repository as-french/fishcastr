...
sum(is.na(met_man_1979_2019$tas_min_manual)) # 443
sum(is.na(met_man_1979_2019$tas_max_manual)) # 421

# consecutive nas
fishcastr::longestNAstrech(met_man_1979_2019$tas_manual) # 100
fishcastr::longestNAstrech(met_man_1979_2019$tas_min_manual) # 100
fishcastr::longestNAstrech(met_man_1979_2019$tas_max_manual) # 92

# ---------------------------------------------------------------------------------------------------------- #
# IMPORT EWEMBI DATA "1979-01-01" "2016-12-31" -------------------------------------------------------------
# ---------------------------------------------------------------------------------------------------------- #
ewembi_1979_2016 <- fishcastr::data_ewembi_1979_2016

# ---------------------------------------------------------------------------------------------------------- #
# IMPORT AUTO STATION DATA "2005-01-01" "2019-09-17" (contains gaps) ---------------------------------------
# ---------------------------------------------------------------------------------------------------------- #
met_auto_2005_2019 <- fishcastr::data_met_auto_station_2005_2019
...
sum(is.na(data_tas_filled$tas_min_manual)) # 307/443 left
sum(is.na(data_tas_filled$tas_max_manual)) # 118/421 left
# consecutive nas
fishcastr::longestNAstrech(data_tas_filled$tas_manual) # 100
fishcastr::longestNAstrech(data_tas_filled$tas_min_manual) # 100
fishcastr::longestNAstrech(data_tas_filled$tas_max_manual) # 45
...
grid_ewembi_1979_2016 <- fishcastr::grid_ewembi_1979_2016
...
# -------------------------------------------------------------------------------------------------------------- #
usethis::use_data(grid_met_obs_1979_2019, overwrite = TRUE)
...
ClimateModelName <- "Furnace_manual_station"
...
usethis::use_data(data_met_obs_1979_2019, overwrite = TRUE)
