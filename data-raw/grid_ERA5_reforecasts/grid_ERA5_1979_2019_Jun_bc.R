# ------------------------------------------------------------------------------------------------------- #
# A script for bias adjusting ECMWF ERA5 data up to Jun 2019 for
...
# BIAS ADJUSTMENT ----
# ------------------------------------------------------------------------------------------------------- #
reanalysis_data <- fishcastr::grid_ERA5_1979_2019_Jun_raw
...
which(is.na(data.bc.cross$pr$Data)) # row 9917 of pr is na (why?)
...
which(is.na(data.bc.cross$pr$Data)) # an NA TRUE 9917
data.bc.cross$pr$Data[9917]
obs.data$pr$Data[9917]
obs.data$pr$Dates$start[9917] # 24th Feb 2006...
data.bc.cross$pr$Dates$start[9917] # 24th Feb 2006...
data.bc.cross$pr$Data[9917] <- obs.data$pr$Data[9917] # replace NA with obs value

# could export at this stage as this section of the time series is independently bias
# corrected vs the operational years
saveRDS(data.bc.cross,file = paste0(getwd(),"/inst/extdata/ERA5_archive_1979_2019/grid_ERA5_1979_2018_bc.rds"))
data.bc.cross <- readRDS(paste0(getwd(),"/inst/extdata/ERA5_archive_1979_2019/grid_ERA5_1979_2018_bc.rds"))
...
#install.packages("C:\\Users\\afrench.INSTITUTE\\OneDrive - Marine Institute\\fishcastr_dev\\package_versions\\transformeR-1.7.4.tar.gz", repos = NULL, type="source")
#install.packages("C:\\Users\\afrench.INSTITUTE\\OneDrive - Marine Institute\\fishcastr_dev\\package_versions\\downscaleR-3.1.3.tar.gz", repos = NULL, type="source")
#devtools::install_github("SantanderMetGroup/downscaleR@v3.1.3") # was 3.3.1
...
# export BC ERA5 data
grid_ERA5_1979_2019_Jun_bc <- data.bc.bind
usethis::use_data(grid_ERA5_1979_2019_Jun_bc, overwrite = TRUE)
# ------------------------------------------------------------------------------------------------------ #
