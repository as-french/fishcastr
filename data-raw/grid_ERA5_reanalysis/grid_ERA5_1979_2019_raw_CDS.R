...
# ERA5 data into R using the climate4R package bundle.
# ------------------------------------------------------------------------------------------------- #
...
grid_ERA5_1979_2019_raw <- ERA5.data
#usethis::use_data(grid_ERA5_1979_2019_raw, overwrite = TRUE)

years <- range(lubridate::year(grid_ERA5_1979_2019_raw$tas$Dates$start))

saveRDS(grid_ERA5_1979_2019_raw,
        file = paste0(
          system.file("inst", package = "fishcastr"),
