# ------------------------------------------------------------------------------------------------------- #
# A script for bias adjusting ECMWF ERA5 data up to June 2019 for
...
reanalysis_data <- readRDS(file = paste0(
  ...
  "/extdata/grid_ERA5_1979_2019_Jun_raw_CDS.rds"
))
...
saveRDS(data.bc.cross,
        file = paste0(
          system.file("inst", package = "fishcastr"),
          "/extdata/data_bc_cross.rds"
        ))

data.bc.cross <- readRDS(file = paste0(
                           system.file("inst", package = "fishcastr"),
                           "/extdata/data_bc_cross.rds"
                         ))
...
saveRDS(grid_ERA5_1979_2019_Jun_bc,
        file = paste0(
          system.file("inst", package = "fishcastr"),
